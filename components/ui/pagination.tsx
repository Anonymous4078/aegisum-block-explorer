...
function PaginationPrevious({ className, ...props }: React.ComponentProps<typeof PaginationLink>): JSX.Element {
	return (
		<PaginationLink
...
function PaginationNext({ className, ...props }: React.ComponentProps<typeof PaginationLink>): JSX.Element {
	return (
		<PaginationLink
