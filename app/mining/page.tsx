...
export default async function MiningPage() {
  ...
  try {
    ...
    [miningStats, difficultyHistory] = await Promise.all([
      getMiningStats(),
      getDifficultyHistory(100),
    ]);
  } catch (error) {
  ...
  const percentMined =
    (miningStats.currentSupply / miningStats.maxSupply) * 100;
    ...
    <main className="container mx-auto px-4 py-6 max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Aegisum network mining information and statistics
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-bold">
                {formatNumber(miningStats.blocks)}
              </h3>
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-bold">
                {miningStats.currentReward} AEGS
              </h3>
              <p className="text-xs text-muted-foreground">
        ...
        <Card>
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              <h3 className="text-2xl font-bold">
                {Number(miningStats.networkhashps?.toFixed(4)) || "0.0000"} GH/s
              </h3>
              <p className="text-xs text-muted-foreground">
          ...
          <CardContent className="p-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs text-amber-800 dark:text-amber-300">
                ~{Math.round(miningStats.daysUntilHalving)} days until reward
                halving
              </p>
            </div>
          </CardContent>
      ...
      <Card className="mb-8">
        <CardHeader>
          ...
          <CardDescription>
            Current Aegisum network performance metrics
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div>
              ...
              <p className="text-xl font-semibold">
                {Number(miningStats.difficulty)?.toLocaleString(undefined, {
            ...
            <div>
              ...
              <p className="text-xl font-semibold">
                {formatNumber(miningStats.maxSupply)} AEGS
              </p>
            </div>
            <div>
              <h3 className="text-sm font-medium text-muted-foreground mb-1">
              ...
              <p className="text-xl font-semibold">
                {formatNumber(miningStats.currentSupply)} AEGS
              </p>
            </div>
          </div>
        </CardContent>
          ...
          <div className="overflow-x-auto">
            <Table>
              ...
              <TableBody>
                ...
                {(!miningStats.halvingSchedule ||
                  miningStats.halvingSchedule.length === 0) && (
                  <TableRow>
                    <TableCell
                      colSpan={5}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex justify-between mt-1 text-xs text-muted-foreground">
                  ...
                  <span>
                    Max Supply: {formatNumber(miningStats.maxSupply)} AEGS
                  </span>
                </div>
              </div>
        ...
        <Card>
          <CardHeader>
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent className="max-w-xs">
                    <p>
                      Aegisum was relaunched and coins were redistributed to all
                      previous holders via these special blocks
                    </p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            ...
            <CardDescription>
              Aegisum relaunch distribution blocks
            </CardDescription>
          </CardHeader>
          <CardContent>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-amber-700 dark:text-amber-400">
                    In March 2025, Aegisum underwent a chain relaunch due to
                    chain synchronization issues with the original blockchain. A
                    total of 2.6 million AEGS were remade and redistributed to
                    all original coin holders based on their previous balances.
                    These special blocks (1-3) were used to facilitate this fair
                    redistribution, ensuring all holders received their coins
                    back after the relaunch.
                  </p>
                </div>
              </div>
            </div>
                          ...
                          {index === 0 && (
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>
                                    First part of redistribution to original
                                    holders
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                          ...
                          {index === 1 && (
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>
                                    Second part of redistribution to original
                                    holders
                                  </p>
                                </TooltipContent>
                              </Tooltip>
                          ...
                          {index === 2 && (
                            <TooltipProvider>
                              <Tooltip>
                                ...
                                <TooltipContent>
                                  <p>
                                    Final part of redistribution to original
                                    holders
                                  </p>
                                </TooltipContent>
                              </Tooltip>
