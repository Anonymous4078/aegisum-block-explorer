      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
              ...
              <Table>
                <TableHeader>
                  <TableRow className="border-slate-700">
                    <TableHead className="w-[80px] text-slate-300">
                      Height
                    </TableHead>
        ...
        <Card className="h-full bg-slate-800/50 border-slate-700">
          <CardHeader>
            ...
            <CardDescription className="text-slate-400">
              Latest transactions on the Aegisum blockchain
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Table>
                  ...
                  >
                    ...
                    <TableCell>
                      {tx.vout[0].addresses ? (
                        <div className="flex items-center gap-2">
                          {(() => {
                            const knownAddress = getKnownAddress(
                              tx.vout[0].addresses,
                            );
                            if (knownAddress) {
                              return (
    ...
    <Card className={`${style.gradient} ${style.border} border`}>
      <CardContent className="p-6">
        <div className="flex items-center justify-between mb-2">
          ...
          <div
            className={`${style.iconBg} p-2 rounded-full ${style.iconColor}`}
          >
            {icon}
          </div>
        </div>
